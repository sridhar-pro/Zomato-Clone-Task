    ...
    <div className="bg-white py-16">
      <div className="container mx-auto px-20">
        <div className="text-left mb-12">
          <h1 className="text-4xl font-normal mb-2 font-geologica text-gray-800">Collections</h1>
          <div className="flex items-center">
            ...
            <p className="text-red-400 flex items-center font-geologica ml-56">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="relative group shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 w-full h-80 mx-auto">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-transparent p-4 text-gray-200">
              <h2 className="text-xl font-normal tracking-normal mb-2 font-geologica">Newly Opened Places</h2>
          ...
          <div className="relative group shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 w-full h-80 mx-auto">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-transparent p-4 text-gray-200">
              <h2 className="text-xl font-normal tracking-normal mb-2 font-geologica">Sea View Dining</h2>
              <p className="font-normal tracking-normal font-geologica">
          ...
          <div className="relative group shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 w-full h-80 mx-auto">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-transparent p-4  text-gray-200">
              <h2 className="text-xl font-normal tracking-normal mb-2 font-geologica">Best Insta-Worthy Places</h2>
              <p className="font-normal tracking-normal font-geologica">
          ...
          <div className="relative group shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 w-full h-80 mx-auto">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-transparent p-4 text-gray-200">
              <h2 className="text-xl font-normal tracking-normal mb-2 font-geologica">Best Buffets In Town</h2>
              <p className="font-normal tracking-normal font-geologica">
