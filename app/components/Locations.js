    ...
    <div className="bg-white py-16">
      <div className="container mx-auto px-20">
        <div className="text-left mb-12">
          <h1 className="text-4xl font-light mb-2 font-geologica text-gray-800">
            Popular localities in and around
            <span className="text-4xl font-normal mb-2 font-geologica text-gray-800 ml-2">
              Chennai
            </span>
          </h1>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {initialLocations.map((location, index) => (
            ...
            >
              <div>
                <h2 className="text-xl font-extralight font-geologica text-gray-800">{location.name}</h2>
                <p className="text-gray-600 font-extralight font-geologica">{location.places}</p>
              </div>
          ...
          {showMore &&
            additionalLocations.map((location, index) => (
              ...
              >
                <div>
                  <h2 className="text-xl font-geologica font-extralight text-gray-800">{location.name}</h2>
                  <p className="text-gray-600 font-geologica font-extralight ">{location.places}</p>
                </div>
                <FaChevronRight className="text-gray-500" />
              </div>
            ))}
          ...
          >
            <div>
              <h2 className="text-xl font-geologica text-gray-800">
