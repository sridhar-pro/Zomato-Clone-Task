...
const CollapsibleBox = ({ title, content }) => {
  ...
  return (
    <div className="bg-white p-6 mb-4 rounded-lg shadow-lg">
      ...
      >
        <h2 className="text-xl font-extralight font-geologica text-gray-800">{title}</h2>
        {isOpen ? <FaChevronUp className="text-gray-500" /> : <FaChevronDown className="text-gray-500" />}
      </div>
      {isOpen && (
        <ul className="mt-4 ml-4 list-none flex flex-wrap text-gray-600 font-extralight font-geologica text-base">
    ...
    <div className="bg-white py-16">
      <div className="container mx-auto px-20">
        <div className="text-left mb-12">
          <h1 className="text-4xl font-normal font-geologica mb-2 text-gray-800">Explore options near me</h1>
        </div>
